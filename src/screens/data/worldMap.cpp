...
#include "../../imgs/WorldMapSprite.h"

extern LGFX tft;

WorldMap::WorldMap() : mapSprite(&tft) {
    // Przypisujemy wymiary z wyeksportowanego pliku obrazka do zmiennych klasy
    map_width = WorldMapSprite_width;
    map_height = WorldMapSprite_height;
...
void WorldMap::load_worldMap_sprites() {
    ...
    loadTintedSprite(mapSprite, WorldMapSprite, map_width, map_height, COLOR_GREEN, COLOR_BG);
}

void WorldMap::drawScreen() {

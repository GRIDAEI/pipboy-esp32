...
extern Entry zadania_entries[];
extern int zadania_max_entries;

class Zadania : public StatsTemplate {
    private:
        LGFX_Sprite zadania_sprites[1];
    public:
        Zadania() : StatsTemplate(zadania_entries, zadania_max_entries) {setInfoMode(3);setEquippable(false);}
